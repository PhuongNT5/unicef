...
function _calculateUI(instance) {
  ...
  const _arr = instance.data.screenSetting.loop ? instance.elements.slideItems : instance.elements.originalItems;
  ...
  if (instance.data.screenSetting.loop && instance.data.pages.active === 0) {
