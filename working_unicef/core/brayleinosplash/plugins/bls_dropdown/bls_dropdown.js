...
function _calculatePosition(instance) {
  ...
  if (instance.setting.position === undefined || instance.setting.position === null) {
  ...
  } else if (instance.setting.position.mode === 'fixed') {
    instance.elements.wrapper.classList.add(`pos-${instance.setting.position.location}`);
  }
}
